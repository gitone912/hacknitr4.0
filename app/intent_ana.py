...
def predict_intent(user_input):
    ...
    vectorizer = joblib.load('/Users/pranaymishra/Desktop/backend_MinMin/backend/app/models/intent_vectorizer.joblib')

    # Vectorize the user input
    user_input_vec = vectorizer.transform([user_input])

    # Load the saved model
    model = joblib.load('/Users/pranaymishra/Desktop/backend_MinMin/backend/app/models/intent_classifier_model.joblib')
